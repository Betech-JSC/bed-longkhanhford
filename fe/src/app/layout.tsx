  ...
  return (
    ...
    >
      <head>
        ...
        <link rel="preload" href="/images-dynamic/ford_ranger_banner.jpg" as="image" type="image/webp" media="(min-width: 768px)" fetchPriority="high" />
        <link rel="preload" href="/images-dynamic/ford_ranger_banner.jpg" as="image" type="image/webp" media="(max-width: 767px)" fetchPriority="high" />
        <script
          suppressHydrationWarning
