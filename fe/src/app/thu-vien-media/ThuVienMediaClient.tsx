...
export interface ThuVienMediaClientProps {
  initialData?: any;
}

function MediaPageContent({ initialData }: { initialData?: any }) {
...
export default function ThuVienMediaClient({ initialData }: ThuVienMediaClientProps) {
  return (
    <Suspense fallback={
      ...
      <MediaPageContent initialData={initialData} />
    </Suspense>
  );
}
