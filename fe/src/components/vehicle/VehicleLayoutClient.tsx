...
export function VehicleTabBar() {
  ...
  const subTabs = useMemo(() => [
    ...
    { label: "Tính trả góp", path: `/cong-cu/uoc-tinh-tra-gop?car=${id}`, actualPath: `/cong-cu/uoc-tinh-tra-gop?car=${id}` }
  ], [id, firstVersionSlug]);
    ...
    <div className="sticky-tabs bg-white border-b border-[#e5e5e5] shadow-xs">
      <div className="max-w-[1440px] mx-auto px-4 xl:px-[80px] w-full flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 md:gap-6 min-w-0 flex-1">
          <div className="m-0 p-0 inline-block font-['Ford_Antenna',sans-serif] font-extrabold text-[#1a1a1a] text-[13px] uppercase tracking-wider whitespace-nowrap hidden sm:block">
            <Link 
              href={`/${id}`}
