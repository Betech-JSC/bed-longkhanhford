...
export default function Navbar() {
  ...
  const getCarDisplayData = (car: { id: string; displayName: string; price?: string; image?: string }) => {
    ...
    const rawImage = vehicle.image_featured_url || vehicle.image_thumbnail_url || vehicle.image_url || (Array.isArray(vehicle.images) ? vehicle.images[0] : vehicle.images) || vehicle.image || getPopularVehicleImage(car.id);
